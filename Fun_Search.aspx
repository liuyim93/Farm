<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fun_Search.aspx.cs" Inherits="Fun_Search" %>
    ...
    <div class="farmintro">
        ...
        <div class="farmintro_content">
            ...
            <div class="farmintro_right">
                <div class="farmintro_right_title">您目前的位置：<a href="Index.aspx" target="_self">首页</a>><a href="Fun.aspx" target="_self">农家娱乐</a>><asp:Literal ID="ltlTitle" runat="server"></asp:Literal></div>
