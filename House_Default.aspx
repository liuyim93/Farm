                            ...
                            <ItemTemplate>
                                <div class="house_area">
                                    <div class="house_area_img">                                                                            
                                        <a href="House_Detail.aspx?id=<%#Eval("ImgID") %>" target="_self"><asp:Image ID="imgHouse" runat="server" ImageUrl='<%#Eval("ImgUrl") %>' Width="190px" Height="150px" /></a>
                                    </div>
